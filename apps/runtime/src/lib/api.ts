...
/** Cliente da API do aprendiz — envia cookies (sessão httpOnly, realm separado do creator). */
export async function apiFetch<T>(
  ...
  try {
    ...
    return { ok: false, status: 0, data: null, problem: { title: 'Falha de conexão com a API.' } };
  }
