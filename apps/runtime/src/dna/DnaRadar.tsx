  ...
  if (loading)
    return (
      <p className="text-xs" style={{ color: theme.muted }}>
        Analisando seu DNA de aprendizagem…
      </p>
    );
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-2 gap-2 text-xs">
        <div>
          <span style={{ color: theme.muted }}>Melhor horário:</span>{' '}
          <span style={{ color: theme.text }}>{profile.bestHour}h</span>
        </div>
        <div>
          <span style={{ color: theme.muted }}>Dias ativos:</span>{' '}
          <span style={{ color: theme.text }}>{profile.activeDays}</span>
        </div>
        <div>
          <span style={{ color: theme.muted }}>Ritmo:</span>{' '}
          <span style={{ color: theme.text }}>{profile.pace}/dia</span>
        </div>
        <div>
          <span style={{ color: theme.muted }}>Conclusão:</span>{' '}
          <span style={{ color: theme.text }}>{profile.completionPercent}%</span>
        </div>
      </div>
