...
export const PALETTES: PaletteSeed[] = [
  ...
  palette(
    'grafite-premium',
    'Grafite Premium',
    { primary: '#334155', secondary: '#1e293b', accent: '#06b6d4' },
    1,
  ),
  ...
  palette(
    'vaporwave',
    'Vaporwave',
    { primary: '#ec4899', secondary: '#be185d', accent: '#06b6d4' },
    1,
  ),
  palette(
    'cibernetico',
    'Cibernético',
    { primary: '#14b8a6', secondary: '#0f766e', accent: '#f43f5e' },
    1,
  ),
  ...
  palette(
    'meia-noite',
    'Meia-noite',
    { primary: '#312e81', secondary: '#1e1b4b', accent: '#4f46e5' },
    1,
  ),
  ...
  palette(
    'crepusculo',
    'Crepúsculo',
    { primary: '#4c1d95', secondary: '#2e1065', accent: '#e11d48' },
    1,
  ),
  palette(
    'floresta-profunda',
