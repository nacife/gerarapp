...
export const TEMPLATE_TOKENS: Record<string, TemplateTokens> = {
  ...
  academic: {
    ...
    surface: 'bordered',
    radius: 'md',
    typography: { heading: 'Georgia', body: 'Inter', scale: 1.4 },
    motion: { level: 'subtle', respectsReducedMotion: true },
  },
  playful: {
    key: 'playful',
    ...
    surface: 'soft-shadow',
    radius: 'xl',
    typography: { heading: 'Nunito', body: 'Nunito', scale: 1.3 },
    motion: { level: 'rich', respectsReducedMotion: true },
  },
  corporate: {
    key: 'corporate',
    ...
    surface: 'flat',
    radius: 'sm',
    typography: { heading: 'Inter', body: 'Inter', scale: 1.15 },
    motion: { level: 'subtle', respectsReducedMotion: true },
  },
  brutalist: {
    key: 'brutalist',
    ...
    surface: 'flat',
    radius: 'none',
    typography: { heading: 'Impact', body: 'Courier New', scale: 1.5 },
    motion: { level: 'subtle', respectsReducedMotion: true },
  },
};
